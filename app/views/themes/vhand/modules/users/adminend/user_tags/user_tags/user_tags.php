...
<nav class="navbar navbar-expand-md navbar-light px-0 py-3">
    <span class="navbar-brand mb-0 h1">
        ...
        <?php if (!empty($userTags->numRows)): ?>
        <span class="badge badge-pill badge-secondary"><?php echo $userTags->numRows; ?></span>
        <?php endif; ?>
    </span>
            ...
            <table class="table table-borderless table-hover table-striped mb-0" _fixed_header>
                ...
                <thead class="border-bottom thead-light">
                    <tr>
                        ...
                        <th scope="col">
                            <a class="d-block text-secondary" href="<?php echo $this->crud->sortingLink('tagName', 'ASC', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?>">
                                <span class="text-nowrap">Name <?php echo $this->crud->sortingIcon('tagName', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?></span>
                            </a>
                        </th>
                        <th scope="col">
                            <a class="d-block text-secondary" href="<?php echo $this->crud->sortingLink('tagDescription', 'ASC', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?>">
                                <span class="text-nowrap">Description <?php echo $this->crud->sortingIcon('tagDescription', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?></span>
                            </a>
                        </th>
                        <th scope="col">
                            <a class="d-block text-secondary" href="<?php echo $this->crud->sortingLink('tagSlug', 'ASC', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?>">
                                <span class="text-nowrap">Slug <?php echo $this->crud->sortingIcon('tagSlug', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?></span>
                            </a>
                        </th>
                        <th scope="col">
                            <a class="d-block text-secondary" href="<?php echo $this->crud->sortingLink('userCount', 'ASC', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?>">
                                <span class="text-nowrap"><i class="fas fa-user-friends fa-fw" title="User count"></i> <?php echo $this->crud->sortingIcon('userCount', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?></span>
                            </a>
                        </th>
                        <?php if (strtolower($this->input->get('filterby', true)) != 'state'): ?>
                        <th scope="col">
                            <a class="d-block text-secondary" href="<?php echo $this->crud->sortingLink('state', 'ASC', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?>">
                                <span class="text-nowrap">State <?php echo $this->crud->sortingIcon('state', $userTags->sortingInfo->orderBy, $userTags->sortingInfo->order); ?></span>
                            </a>
                        </th>
                        <?php endif; ?>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a class="d-inline-block text-info" href="<?php echo site_url([$this->uri->segment(1), $this->uri->segment(2), $this->uri->segment(3), 'edit', $userTag->ID]); ?>" title="Edit user tag">
                                <i class="fas fa-edit fa-fw"></i>
                            </a>
                        </td>
                        <td><?php echo $userTag->tagName; ?></td>
                        <td><?php echo $userTag->tagDescription; ?></td>
                        <td><?php echo $userTag->tagSlug; ?></td>
                        <td>
                            <a class="badge badge-pill badge-secondary" href="<?php echo site_url([$this->uri->segment(1), $this->uri->segment(2)]); ?>?filterby=tagID&filter=<?php echo $userTag->ID; ?>">
                                <?php echo $userTag->userCount; ?>
                            </a>
                        </td>
                        <?php if (strtolower($this->input->get('filterby', true)) != 'state'): ?>
                        <td>
                            <?php if (strtolower($userTag->state) == 'active'): ?>
                            <span class="badge badge-pill badge-success font-weight-normal"><?php echo ucfirst($userTag->state); ?></span>
                            <?php elseif (strtolower($userTag->state) == 'inactive'): ?>
                            <span class="badge badge-pill badge-danger font-weight-normal"><?php echo ucfirst($userTag->state); ?></span>
                            <?php else: ?>
                            <span class="badge badge-pill badge-secondary font-weight-normal"><?php echo ucfirst($userTag->state); ?></span>
                            <?php endif; ?>
                        </td>
                        <?php endif; ?>
                    </tr>
