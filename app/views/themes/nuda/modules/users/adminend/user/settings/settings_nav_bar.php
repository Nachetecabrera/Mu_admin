...
/*!
|--------------------------------------------------------------------------
| User settings nav bar view file
|
| Author:       Nudasoft
...
/**
 * Complete user settings nav bar template.
 */

?>

<nav class="py-3">
    <span class="navbar-brand mb-0 h1">User settings</span>
</nav>

<?php if ($this->session->flashdata('editUserSettingsSuccess') === true): ?>
...
<?php if ($this->session->flashdata('editUserSettingsSuccess') === false): ?>
